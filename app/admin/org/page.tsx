...
export default function AdminOrgPage() {
  ...
  useEffect(() => {
    ...
    if (!valid) {
      router.replace('/admin/admin-login?next=/admin/org');
      return;
    }
  ...
  async function createOrg(e: React.FormEvent) {
    ...
    if (!hasAccess) {
      setMessage('You do not have permission to create an organization.');
      return;
    }
  ...
  if (!accessChecked) {
    return <main className="mx-auto max-w-5xl px-6 py-10">Checking admin access...</main>;
  }
    ...
    <main className="mx-auto max-w-5xl px-6 py-10">
      ...
      <div className="mb-8">
        ...
        <p className="mt-2 text-slate-600">
          Manage clubs and organizations across your teams.
        </p>
      </div>
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <div className="truncate text-sm text-slate-500">
                    {'organization_type' in org
                      ? (org as Organization & { organization_type?: string }).organization_type?.replace(
                          /_/g,
                          ' ',
                        ) || 'Unknown'
                      : 'Unknown'}
              ...
              <div className="mt-4 flex flex-wrap gap-2">
                ...
                <span
                  className={`rounded-full px-3 py-1 text-xs font-semibold ${
                    'is_public' in org && (org as Organization & { is_public?: boolean }).is_public
