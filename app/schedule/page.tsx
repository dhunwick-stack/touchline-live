...
export default function SchedulePage() {
  ...
  async function loadData() {
    ...
    if (matchError || seasonError) {
      setMessage(matchError?.message || seasonError?.message || 'Failed to load schedule.');
      setLoading(false);
      return;
    }
      ...
      <div className="mb-8 flex flex-wrap items-end justify-between gap-4">
        <div>
          ...
          <p className="mt-2 text-slate-600">
            Upcoming fixtures, live matches, and scheduling updates.
          </p>
        </div>
...
>
  ...
  <path d="m21 21-4.3-4.3" />
              ...
              <input
                ...
                placeholder="Search teams, venue, or status"
